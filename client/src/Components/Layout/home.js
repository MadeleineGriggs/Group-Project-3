              ...
              <Grid item xs={4}>
                <div className="sign-up-container">
                  ...
                  <form onSubmit={(e) => this.handleSubmitUser(e)}>
                      ...
                      <TextField required name="userName" id="signupUsername" type="text" className="form-control" />
                      <br></br>
                      <InputLabel htmlFor="signupJobTitle">Job Title</InputLabel>
                      <TextField required name="jobTitle" id="signupJobTitle" type="text" className="form-control" />
                      <br></br>
                      <InputLabel htmlFor="signupHourRate">Salary</InputLabel>
                      <TextField required name="hourRate" type="text" id="signupHourRate" className="form-control" />
                      <br></br>
                      <InputLabel htmlFor="signupEmail">Email</InputLabel>
                      <TextField required name="emailAddress" id="signupEmail" type="text" className="form-control" />
                      <br></br>
                      <InputLabel htmlFor="signupCompany">Company Name</InputLabel>
                      <TextField required name="company" id="signupCompany" type="text" className="form-control" />
                      <br></br>
                      <InputLabel htmlFor="signupPassword">Password</InputLabel>
                      <TextField required name="userPassword" id="signupPassword" type="text" className="form-control" />
                      <br></br>
                      <br></br>
...
{/* The Top Nav Bar */}
        <AppBar position="static" color="primary">
          ...
          <Grid container 
            ...
            <Grid item xs={3}>
            <Button onClick={(e) => this.toggleModal(e)}  variant="contained" color="primary" >Login | Signup</Button>
            </Grid>
          </Grid>
          </Toolbar>
        </AppBar>
